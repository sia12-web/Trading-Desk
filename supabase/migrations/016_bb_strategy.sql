...
COMMENT ON COLUMN bb_sessions.bb_period IS 'Bollinger Bands lookback period (typically 20)';
COMMENT ON COLUMN bb_sessions.bb_std_dev IS 'Bollinger Bands standard deviation (typically 2.0)';
COMMENT ON COLUMN bb_sessions.stoch_period IS 'Stochastic oscillator period (typically 14)';
COMMENT ON COLUMN bb_sessions.oversold_level IS 'Stochastic oversold threshold (typically 20)';
COMMENT ON COLUMN bb_sessions.overbought_level IS 'Stochastic overbought threshold (typically 80)';
